...
const BackeryMap = () => {
  ...
  function backeryDummyData(listData) {
    ...
    // {
    //   const address = bakeryList[i].storeAddress1 + " " + bakeryList[i].storeAddress2;
    //   titles.push(bakeryList[i].storeName);
    //   latitudes.push(bakeryList[i].latitude);
    //   longitudes.push(bakeryList[i].longitude);
    //   contents.push(`<div class="wrap">` +
    //   `<div class="info">` +
    //   `<div class="title">` +
    //   `${bakeryList[i].storeName}` +
    //   `</div>` +
    //   `<div class="body">` +
    //   `<div class="img">` +
    //   `<img src='${bakeryList[i].bakeryPath}' width="73" height="70">` +
    //   `</div>` +
    //   `<div class="desc">` +
    //   `<div class="ellipsis">${address}</div>` +
    //   `<div class="ellipsis">${bakeryList[i].storeContact}</div>` +
    //   `</div>` +
    //   `</div>` +
    //   `</div>` +
    //   `</div>`)
